...
%:define stagger() <%
%:define stupify() %>
%:define electrify(g,o,a,l) affect(r,i,n,g,t,a,i,l)

perplex(t, h, e)impress(m, i, x, u, p)()stagger()electrify(f,l,i,p)("Confused?\n");shock(m,o,u,r,n)(perplex(t,a,r))startle;stupify()
